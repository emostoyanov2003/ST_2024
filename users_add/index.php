...
<head>
    ...
    <title>Admin panel | Добавяне на потребител</title>
...
<body>
    ...
    <div class="admin_page_container">
        <p class="admin_page_label">Добавяне на потребител</p>
        <?php
            error_reporting(0);
            echo '
                <form method="post" enctype="multipart/form-data">
                    <input type="text" name="email" id="email" class="universal_input" placeholder="E-mail" autocomplete="off">
                    ...
                    <input type="submit" name="submit" class="universal_submit_btn" value="Добави потребител">
                </form>
            ';
            $email = $_POST["email"];
            ...
            if(isset($_POST["submit"]) && $email != "" &&  $password != "" &&  $password_confirm != "" && $password == $password_confirm){
                $sqlInsert = "INSERT INTO `users`(`id`, `e-mail`, `password`, `type`, `added_date`) VALUES
                    (NULL, '$email', '$password', 'admin', current_timestamp())";
